...
def recognize(image,TOLERANCE): 
    ...
    for (top,right,bottom,left),face_encoding in zip(face_locations,face_encodings):
        ...
        cv2.rectangle(image,(left,top),(right,bottom),(0,0,150),2)
        cv2.rectangle(image,(left, bottom + 35), (right, bottom),(0,0,150), cv2.FILLED)
        cv2.putText(image,name,(left + 5, bottom + 25) ,cv2.FONT_HERSHEY_SIMPLEX,0.55,(0,0,0),1)
